...
- public documentation and verified external download links.
...
When redistribution rights are unclear, the launcher may provide a link to a
verified official project page or download source instead. Users may also need
to contact the operator of the server they want to join.

This approach protects mod authors, users and the project from unapproved or
modified packages. A link is not an endorsement of all content on the external
website, and users leave the launcher project when opening it.
